...
public abstract class AbstractEntityPresentationService<ENTITY extends IBusinessObject<ID>,VO, ID extends Serializable> extends AbstractCRUDService<VO,ID> {
