...
public class JavaXCollectionJoinProxy<X, T> implements javax.persistence.criteria.CollectionJoin<X, T> {
    private final CollectionJoin<X, T> actual;

    public JavaXCollectionJoinProxy( CollectionJoin<X, T> actual )
    {
        this.actual = actual;
    }

    @Override public javax.persistence.criteria.CollectionJoin<X, T> on( Expression<Boolean> expression )
    {
        return null;
    }

    @Override public javax.persistence.criteria.CollectionJoin<X, T> on( Predicate... predicates )
    {
        return null;
    }
    ...
    @Override public CollectionAttribute<? super X, T> getModel()
    {
        return null;
    }
    ...
    @Override public <Y> javax.persistence.criteria.CollectionJoin<T, Y> join( CollectionAttribute<? super T, Y> collectionAttribute )
    {
        return null;
    }
    ...
    @Override public <Y> javax.persistence.criteria.CollectionJoin<T, Y> join( CollectionAttribute<? super T, Y> collectionAttribute, JoinType joinType )
    {
        return null;
    }
    ...
    @Override public <X1, Y> javax.persistence.criteria.CollectionJoin<X1, Y> joinCollection( String s )
    {
        return null;
    }
    ...
    @Override public <X1, Y> javax.persistence.criteria.CollectionJoin<X1, Y> joinCollection( String s, JoinType joinType )
    {
        return null;
    }
