...
public class JavaXMapJoinProxy<X, K, T> implements javax.persistence.criteria.MapJoin<X, K, T> {
    private MapJoin<X, K, T> actual;

    public  JavaXMapJoinProxy( MapJoin<X, K, T> actual )
    {
        this.actual = actual;
    }

    @Override public javax.persistence.criteria.MapJoin<X, K, T> on( Expression<Boolean> expression )
    {
        return null;
    }

    @Override public javax.persistence.criteria.MapJoin<X, K, T> on( Predicate... predicates )
    {
        return null;
    }
    ...
    @Override public MapAttribute<? super X, K, T> getModel()
    {
        return null;
    }
    ...
    @Override public Path<T> value()
    {
        return null;
    }

    @Override public Expression<Map.Entry<K, T>> entry()
    {
        return null;
    }
    ...
    @Override public <K, V> javax.persistence.criteria.MapJoin<T, K, V> join( MapAttribute<? super T, K, V> mapAttribute )
    {
        return null;
    }
    ...
    @Override public <K, V> javax.persistence.criteria.MapJoin<T, K, V> join( MapAttribute<? super T, K, V> mapAttribute, JoinType joinType )
    {
        return null;
    }
    ...
    @Override public <X1, K, V> javax.persistence.criteria.MapJoin<X1, K, V> joinMap( String s )
    {
        return null;
    }
    ...
    @Override public <X1, K, V> javax.persistence.criteria.MapJoin<X1, K, V> joinMap( String s, JoinType joinType )
    {
        return null;
    }
