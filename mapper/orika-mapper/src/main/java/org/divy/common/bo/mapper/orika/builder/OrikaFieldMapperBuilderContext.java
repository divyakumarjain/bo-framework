...
public class OrikaFieldMapperBuilderContext<S, T> implements FieldMapperBuilderContext{
    private TypeMapperBuilderContext typeMapperBuilderContext;
    private List<MapperBuilderOption> mapperBuilderOptions;

    public OrikaFieldMapperBuilderContext(TypeMapperBuilderContext typeMapperBuilderContext) {
